package Exercicio02.Visualization.Login.Telas;


import Exercicio02.Visualization.Login.Buttons.SignInButton;
import Exercicio02.Visualization.Login.Buttons.SignUpButton;
...
public class TelaLogin extends JFrame {
    ...
    public void loadLanguage() {
        ...
        switch (n) {
            case 0:
                bn = ResourceBundle.getBundle("Exercicio02.Visualization.Login.Telas.Aula15",  new Locale("pt", "BR"));
                break;
            case 1:
                bn = ResourceBundle.getBundle("Exercicio02.Visualization.Login.Telas.Aula15", Locale.US);
                break;
        }
        if (instance != null) {
