...
{  public static void main(String[] args) throws Exception
   {  String   sMsgClara = FileTextEditor.readFileMsg("MsgClara.txt");
      ...
      // Imprime cabecalho da mensagem
      System.out.println("Mensagem Cifrada (String):");
      // Imprime o texto no arquivo txt ;)
      FileTextEditor.writeFileMsg("texto_cifrada.txt",sMsgCifrada);
      // Imprime o texto cifrado em String
      System.out.println(sMsgCifrada);
      ...
      // Imprime o texto decifrado em String
      System.out.println(sMsgDecifrada);
      // Imprime o texto no arquivo tx :)
      FileTextEditor.writeFileMsg("texto_decifrado.txt", sMsgDecifrada);
      System.out.println(""); 
      /*
       * Criptografia RSA --------------------------------------------------------------
       */
